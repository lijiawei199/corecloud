...
public class MarketApiController implements MarketApi {
    ...
    private final MarketApiDelegate delegate;

    public MarketApiController(@org.springframework.beans.factory.annotation.Autowired(required = false) MarketApiDelegate delegate) {
        this.delegate = delegate;
    }

    public ResponseEntity<Capital> capital() {
        return delegate.capital();
    }
