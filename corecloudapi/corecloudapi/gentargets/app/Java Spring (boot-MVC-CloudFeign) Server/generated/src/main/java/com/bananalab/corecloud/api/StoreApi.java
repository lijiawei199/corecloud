...
public interface StoreApi {
    ...
    @RequestMapping(value = "/store/capital",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    ResponseEntity<Capital> capital(@NotNull @ApiParam(value = "", required = true) @Valid @RequestParam(value = "month", required = true) Integer month);


    @ApiOperation(value = "", nickname = "cunsume", notes = "店铺能源消费  0 1 2 水电气    0 正常 1 异常", response = StoreCunsume.class, tags={ "店铺信息交互", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "success", response = StoreCunsume.class) })
    @RequestMapping(value = "/store/cunsume",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    ResponseEntity<StoreCunsume> cunsume(@NotNull @ApiParam(value = "", required = true) @Valid @RequestParam(value = "fid", required = true) String fid);


    @ApiOperation(value = "", nickname = "leaseTime", notes = "店铺租约划分 low 即将到期 high 正常", response = StoreList.class, tags={ "店铺租约划分", })
    @ApiResponses(value = { 
    ...
    @ApiOperation(value = "", nickname = "storeCunsumeList", notes = "店铺能源消费列表 low正常 high异常", response = StoreList.class, tags={ "店铺信息交互", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "success", response = StoreList.class) })
    @RequestMapping(value = "/store/cunsumeList",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    ResponseEntity<StoreList> storeCunsumeList(@NotNull @ApiParam(value = "", required = true) @Valid @RequestParam(value = "floor", required = true) String floor);
